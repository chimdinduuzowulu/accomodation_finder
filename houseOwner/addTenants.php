...
if(isset($_POST["submit"]))
{
  $H_no = $_POST["H_no"];
  $Email = $_POST["email"];
  $expiryDate= date('y-m-d',strtotime("+12 months", strtotime($expiryDate)));
   $put = "UPDATE TenantTb SET HouseOwner_Id ='$HouseOwner_Id', House_number ='$H_no',expiryDate ='$expiryDate', paidDate='$paidDate' WHERE Email = '$Email'";
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
         ...
         <li class="nav-item">
          <a class="nav-link text-white active bg-gradient-primary" href="addTenants.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <div class="card z-index-0 fadeIn3 fadeInBottom">
              <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                <div class="bg-gradient-primary shadow-primary border-radius-lg py-3 pe-1">
                  <h4 class="text-white font-weight-bolder text-center mt-2 mb-0">Add Tenant</h4>
                  <div class="row mt-3">
              ...
              <div class="card-body">
                ...
                <div class="input-group input-group-outline my-3">
                    ...
                    <input type="text" class="form-control" name="H_no" placeholder="House number">
                  </div>
                  
                  <div class="input-group input-group-outline my-3">
                    <label class="form-label"></label>
                    <input type="text" class="form-control" name="email" placeholder="Tenant Email">
                  </div>
                   
                  <div class="text-center">
                    <button type="submit" name="submit" class="btn bg-gradient-primary w-100 my-4 mb-2">Add</button>
                  </div>
                </form>
                <div class="text-center">
